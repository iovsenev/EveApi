...
public class FetchOrdersForTypeIdAsyncTests
{
    ...
    public async Task GetTypeOrdersInfo_ReturnsOrders_WhenApiResponseIsSuccessful()
    {
        ...
        // Act
        var result = await provider.FetchOrdersForTypeIdAsync(RegionId,TypeId, CancellationToken.None);
    ...
    public async Task GetTypeOrdersInfo_ReturnsOrders_WhenApiResponseContainsManyPages()
    {
        ...
        // Act
        var resultRequest = await provider.FetchOrdersForTypeIdAsync(RegionId, TypeId, CancellationToken.None);
