...
public class GetChildTypesForMarketGroupIdHandlerTests
{
    private readonly GetChildTypesForMarketGroupIdHandler _handler;
    private readonly Mock<IReadMarketGroupRepository> _repos;
    private readonly Mock<IMapper> _mapper;
    private List<TypeEntity> _entities;

    public GetChildTypesForMarketGroupIdHandlerTests()
    {
        _repos = new();
        _mapper = new();
