...
public class GetMarketGroupsHandler : IRequestHandler<GetMarketGroupsResponse , GetMarketGroupsRequest>
{
    ...
    public async Task<Result<GetMarketGroupsResponse>> Handle(GetMarketGroupsRequest req, CancellationToken token)
    {
